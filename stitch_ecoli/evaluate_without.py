...
if cs == 150:
    shared_mpis_file= 'stitch_ecoli_150_shared_mpis.csv'
elif cs == 400:
    shared_mpis_file= 'stitch_ecoli_400_shared_mpis.csv'
elif cs == 700:
    shared_mpis_file= 'stitch_ecoli_700_shared_mpis.csv'
elif cs == 900:
    shared_mpis_file= 'stitch_ecoli_900_shared_mpis.csv'
else:
    sys.exit()
