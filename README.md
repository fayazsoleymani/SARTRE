...
Curation of these mentioned GEMs have been performed by the  COBRAToolbox in MATLAB. [`modelPreparing_iJO1366.m`](models/modelPreparing_iJO1366.m) uses `iJO1366.mat` as the input and creates `ModelIrrevOpt90.mat` and  `modelPreparing_yeastGEM.m` uses `Yeast-GEM.mat` and creates `yeast_IrrevOpt90.mat`.
