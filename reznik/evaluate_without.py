...
def make_dataset_exception(met_names, met_features, gene_names, gene_features, exceptions):
...
shared_mpis_file= 'reznik_shared_mpis.csv'
shared_mpis= set()
...
X, y= make_dataset_exception(metabolites_names, metabolites_features, protein_names, protein_features, shared_mpis)
